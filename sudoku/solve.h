...
void ConsoleInput(char InputString[])
{
...
void soluation(char *fileargv)
{
	ifstream in(fileargv);
	if (!in.is_open())
	{
		cout << "无法打开文件" << endl;
		return;
